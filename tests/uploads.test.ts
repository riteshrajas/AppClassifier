import fs from 'fs';
import type { ResponseLike } from 'appclassifier/internal/to-file';
import { toFile } from 'appclassifier/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('appclassifier/core/uploads');
    await expect(
